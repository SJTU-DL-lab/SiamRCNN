...
def crop_img(img, anns, set_crop_base_path, set_img_base_path,
    ...
    # change anns to valid_anns
    # for track_id, ann in enumerate(anns):
    for track_id, ann in enumerate(valid_anns):
...
def main(exemplar_size=127, context_amount=0.5, search_size=511, enable_mask=True, num_threads=24):
    ...
    # for data_subset in ['val2017']:
        ...
        anno_file = '{}/annotations/person_keypoints_{}.json'.format(data_dir, data_subset) #added for pose
        coco = COCO(anno_file)
