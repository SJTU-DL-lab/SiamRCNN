from models.siampose_RCNN_corr import SiamMask
...
class Center_pose_head(nn.Module):
    def __init__(self, head_conv=256):
        ...
        #     [4, 4, 4],
        # )
        self.deconv_layers_new = self._make_deconv_layer(
            3,
            [512, 256, 64],
            [4, 4, 4],
        )
...
class PoseCorr(Mask):
    def __init__(self):
        super(PoseCorr, self).__init__()
        self.kp = DepthCorr(256, 512, 512)
